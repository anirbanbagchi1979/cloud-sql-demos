...
def main() -> None:
    ...
    print(db_user,db_pass,db_name,db_host,db_socket_dir,instance_connection_name,credentials,key_uri)
...
def encrypt_and_insert_data(
    ...
    env_aead: cloud_kms_env_aead.aead.KmsEnvelopeAead,
    table_name: str,
    team: str,
    email: str,
) -> None:
